...
Com o servidor rodando e o banco de dados ativo, abra o arquivo principal index.html (ou a rota inicial configurada) diretamente em seu navegador web preferido para operar o sistema.
